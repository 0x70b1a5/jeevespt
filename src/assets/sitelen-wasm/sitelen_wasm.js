 ...
 * @returns {string}
 */
function render_svg(text, optimal_ratio) {
    let deferred3_0;
    let deferred3_1;
    try {
 ...
 * @returns {Uint8Array}
 */
function render_png(text, optimal_ratio) {
    const ptr0 = passStringToWasm0(text, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.render_png(ptr0, len0, !isLikeNone(optimal_ratio), isLikeNone(optimal_ratio) ? 0 : optimal_ratio);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
 ...
 * @returns {string}
 */
function get_layout_ratios(text) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(text, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
 ...
 * @returns {string}
 */
function render_sentences(text, optimal_ratio) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(text, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
 ...
 */
function init_glyphs(sprite_content) {
...
function __wbg_get_imports() {
    const imports = {};
    imports.wbg = {};
    imports.wbg.__wbg_log_ceecb5fbf128b811 = function(arg0, arg1) {
